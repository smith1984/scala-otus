...
object zioConcurrency {
  ...
  lazy val getFrom2Locations =
    getExchangeRatesLocation1 <*> getExchangeRatesLocation2
  ...
  lazy val greeter = (sleep1Second *> putStrLn("Hello")).forever
