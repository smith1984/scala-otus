...
object adt {
  ...
  object case_classes {
    ...
    case class CreditCard(number: String, date: java.time.YearMonth,
                          name: String, cvc: Short)
  ...
  object sealed_traits {
    ...
    final case class CreditCard(number: String, date: LocalDate) extends PaymentMethod
    final case class WireTransfer(bic: String, name: String) extends PaymentMethod
